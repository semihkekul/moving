...
#ifndef _GIRESUN_PFGEN_H_
#define _GIRESUN_PFGEN_H_
...
namespace Giresun {
    ...
    public:
        ...
        ParticleAnchoredSpring(Vector2D *anchor,
							   real springConstant, 
							   real restLength);

		/** Retrieve the anchor point. */
		const Vector2D* getAnchor() const { return anchor; }

		/** Set the spring's properties. */
		void init(Vector2D *anchor,
				  real springConstant, 
				  real restLength);
	...
	*/
    ...
    public:
        ...
        /** Creates a new spring with the given parameters. */
        ParticleFakeSpring(Vector2D *anchor, real springConstant,
            real damping);
